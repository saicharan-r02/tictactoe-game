...
# Panel 1 : Line Chart 
ax1.plot(x, y_sin,label='Sine',color='royalblue',linewidth=2,marker='o',markevery=30,markersize=5)
ax1.plot(x, y_cos,label='Cosine',color='indianred', linestyle='--', linewidth=2,marker='s',markevery=30,markersize=5)
...
for bar in bars:
    ...
    ax2.annotate(f'{height}',xy=(bar.get_x()+bar.get_width()/2,height),xytext=(0,5),textcoords='offset points',ha='center',va='bottom',fontsize=11,fontweight='bold')

#Panel 3:Scatter Plot
sc=ax3.scatter(scatter_x,scatter_y,c=scatter_c,cmap='coolwarm',alpha=0.7,edgecolors='white',linewidths=0.4,s=60)
