...
=======================================
Visualises sales distribution across product categories using a styled
exploded pie chart with custom colors and percentage labels.
...
ax.set_title(
    'Category-wise Distribution of Sales Values',
